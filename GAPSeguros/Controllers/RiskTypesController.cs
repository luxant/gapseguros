...
namespace GAPSeguros.Controllers
{
    public class RiskTypesController : Controller
    {
        ...
        public RiskTypesController(GAPSegurosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var riskType = await _context.RiskType.SingleOrDefaultAsync(m => m.RiskTypeId == id);
            if (riskType == null)
            {
                return NotFound();
            }
        ...
        {
            return _context.RiskType.Any(e => e.RiskTypeId == id);
        }
    }
}
